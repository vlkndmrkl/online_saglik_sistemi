...
public class admin_mesaj_gelen extends AppCompatActivity {
        ...
        StringRequest MyStringRequest = new StringRequest(Request.Method.POST, adres, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    icerik=randevudizi2;
                    ArrayAdapter<String> adapter = new ArrayAdapter<String>(admin_mesaj_gelen.this, simple_list_item_1, randevudizi);
                    mesajlar.setAdapter(adapter);
                    mesajlar.setOnItemClickListener(new ListClickHandler());
                } catch (JSONException e) {
                    Toast.makeText(admin_mesaj_gelen.this, "HATA", Toast.LENGTH_SHORT).show();
                }
            }
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                if (networkResponse !=null && networkResponse.statusCode==404)
                    Toast.makeText(admin_mesaj_gelen.this, "Mesaj Bulunamadı", Toast.LENGTH_SHORT).show();
                else if (networkResponse !=null && networkResponse.statusCode==500)
                    Toast.makeText(admin_mesaj_gelen.this, "Bilinmeyen Bir Hata Oluştu Tekrar Deneyiniz", Toast.LENGTH_SHORT).show();
                else
                    Toast.makeText(admin_mesaj_gelen.this, "Hata"+error, Toast.LENGTH_SHORT).show();
            }
        }){
    ...
    public class ListClickHandler implements AdapterView.OnItemClickListener {
        ...
        public void onItemClick(AdapterView<?> adapter, View view, int position, long arg3) {
            AlertDialog.Builder builder = new AlertDialog.Builder(admin_mesaj_gelen.this);
