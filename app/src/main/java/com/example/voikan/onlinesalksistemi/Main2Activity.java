    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        gecis.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent istek = new Intent(getApplicationContext(), gunluk_bilgiler.class);
                startActivity(istek);
            }
        });
        ...
        gecis2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent istek = new Intent(getApplicationContext(), doktor_anaekran.class);
                startActivity(istek);
            }
        });
        ...
        gecis3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent istek = new Intent(getApplicationContext(), kullanici_islem_anaekran.class);
                startActivity(istek);
            }
        });
        ...
        gecis4.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent istek = new Intent(getApplicationContext(), sikayet.class);
                startActivity(istek);
            }
        });
        ...
        gecis6.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent istek = new Intent(getApplicationContext(), kul_doktorum.class);
                startActivity(istek);
            }
        });
    }
